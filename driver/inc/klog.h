...
#define KL_INFO 	KL_INFO_L,__LOGNAME__,__SUBCOMPONENT__,__FILE__, __LINE__, __FUNCTION__
#define KL_ERR 		KL_ERR_L,__LOGNAME__,__SUBCOMPONENT__,__FILE__, __LINE__, __FUNCTION__
#define KL_DEBUG	KL_DEBUG_L,__LOGNAME__,__SUBCOMPONENT__,__FILE__, __LINE__, __FUNCTION__
#define KL_WARN 	KL_WARN_L,__LOGNAME__,__SUBCOMPONENT__,__FILE__, __LINE__, __FUNCTION__
